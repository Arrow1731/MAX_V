  ...
  render() {
    return (
      <div>
        ...
        <main className='bg-[#000]'>
          <section className='py-[64px] sm:py-[129px] bg-[#0B0B0B] border-t-2 border-b-2 border-[#1B1B1B]'>
            <div className='container px-4 flex flex-col lg:flex-row gap-12 items-start'>

              {/* Left: Google Map */}
              <div className='w-full lg:w-[750px]'>
                <div className='w-full h-[420px] rounded-[14px] border border-[#1B1B1B] overflow-hidden shadow-lg'>
                  <iframe
                    src={GOOGLE_MAP_EMBED}
                    className='w-full h-full'
                    allowFullScreen
                    loading="lazy"
                    title="MAX-V Location"
                  />
                </div>
              </div>
              ...
              <div className='w-full lg:flex-1'>
                <div className='bg-[#060606] p-8 rounded-[18px] border border-[#1B1B1B] shadow-xl'>
                  <h2 className='text-[26px] font-bold text-[#EEEEEE] mb-6 text-center'>
                    Request a Project
                  </h2>
                  <RequestForm />
                </div>
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
      ...
      <input
        ...
        onChange={handleChange}
        required
        className='p-4 rounded-lg bg-[#111111] border border-[#2A2A2A] text-white w-full focus:border-[#0086A1] focus:outline-none transition'
      />
      ...
      <textarea
        ...
        onChange={handleChange}
        required
        className='p-4 rounded-lg bg-[#111111] border border-[#2A2A2A] text-white w-full h-32 focus:border-[#0086A1] focus:outline-none transition'
      />

      <button
        type="submit"
        className='bg-gradient-to-r from-[#0086A1] to-[#00a5c2] text-white py-4 rounded-lg font-semibold mt-3 hover:opacity-90 transition'
      >
        Send Request
      </button>
