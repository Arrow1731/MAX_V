    ...
    <footer className="bg-[#0B0B0B] py-[48px]">
      <div className="container px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-[32px] mb-[32px]">
          ...
          <div>
            <h2 className="text-[18px] font-bold text-[#EEEEEE] mb-[17px]">Contact Us</h2>
            <span className="flex gap-2 mb-[12px] text-[#9E9E9E]"><Phone />+998 (71) 200 12 34</span>
            <span className="flex gap-2 mb-[12px] text-[#9E9E9E]"><Mail />hello@max-v.uz</span>
            <span className="flex gap-2 mb-[12px] text-[#9E9E9E]"><MapPin />Khorezm, Uzbekistan</span>
          </div>
          ...
          <div>
            <h2 className="text-[18px] font-bold text-[#EEEEEE] mb-[17px]">Follow Us</h2>
            <div className="flex gap-[12px]">
              <a href="#!" className='bg-[#222222] px-[12px] py-[12px] rounded-[10px]'><Github className='text-[#EEEEEE]' /></a>
              <a href="#!" className='bg-[#222222] px-[12px] py-[12px] rounded-[10px]'><Linkedin className='text-[#EEEEEE]' /></a>
              <a href="#!" className='bg-[#222222] px-[12px] py-[12px] rounded-[10px]'><Mail className='text-[#EEEEEE]' /></a>
            </div>
          </div>
